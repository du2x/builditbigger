 ...
 * on 2015-08-25 at 14:54:28 UTC 
 * Modify at your own risk.
 */

package com.udacity.gradle.gaejokes.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-1048.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.udacity.gradle.gaejokes.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.udacity.gradle.gaejokes.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.udacity.gradle.gaejokes.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.gradle.gaejokes.myApi.model.MyBean.class);
